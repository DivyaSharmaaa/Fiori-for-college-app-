		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "lecturer",
									"targetURL": "#lecturerworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"lecturerworkflowuimodule-display": {
								"semanticObject": "lecturerworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lecturer.workflowuimodule",
									"url": sap.ui.require.toUrl("lecturer/workflowuimodule")
								}
							}
						}
					}
